...
# Train nsa model with optimized memory settings
...
BATCH_SIZE=${2:-8}
BLOCK_SIZE=${3:-2048}
OUTPUT_DIR=${4:-out_nsa_optimized}
...
echo "Training nsa model with optimized memory settings..."
...
# in _create_nsa_config to set use_gradient_checkpointing=False
